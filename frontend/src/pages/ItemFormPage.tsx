    ...
    <div className="page-container">
      ...
      <div className="max-w-2xl">
        <form onSubmit={handleSubmit} className="space-y-4 detail-card">
          <h2 className="text-lg font-semibold text-text mb-4">New Item</h2>
          <div className="detail-grid gap-4">
            <div>
              <label className="block text-sm font-medium text-text-muted mb-1">SKU * (max 16 chars, letters, numbers, - and _)</label>
              <input
                type="text"
                value={form.sku}
